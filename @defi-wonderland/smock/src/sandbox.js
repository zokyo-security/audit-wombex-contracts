...
class Sandbox {
    ...
    async fake(spec, opts = {}) {
        return (0, smock_contract_1.createFakeContract)(this.vm, opts.address || (0, utils_1.makeRandomAddress)(), await (0, ethers_interface_1.ethersInterfaceFromSpec)(spec), opts.provider || hardhat_1.default.ethers.provider);
    }
    async mock(contractName, signerOrOptions) {
        return (0, smock_contract_1.createMockContractFactory)(this.vm, contractName, signerOrOptions);
    }
    static async create() {
