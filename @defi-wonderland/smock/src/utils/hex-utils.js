...
const toHexString32 = (value) => {
    if (typeof value === 'string' && value.startsWith('0x')) {
        if (value.length === 42) {
            return '0x' + (0, exports.remove0x)(value).padStart(64, '0').toLowerCase();
        }
        else {
            return '0x' + (0, exports.remove0x)(value).padEnd(64, '0').toLowerCase();
        }
    }
        ...
        return '0x' + (0, exports.remove0x)(ethers_1.BigNumber.from(value).toHexString()).padStart(64, '0').toLowerCase();
    }
};
