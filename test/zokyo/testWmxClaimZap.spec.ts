...
//             const claimZapFactory = await ethers.getContractFactory("WmxClaimZap");
            
//             // console.log(claimZapFactory);
//             // console.log(await contracts.claimZap.wom());
//             //    console.log( await contracts.claimZap.wmx());
//             //     console.log(await contracts.claimZap.womWmx());
//             //     console.log(DEAD_ADDRESS);
//             //     console.log(await contracts.claimZap.wmxWomRewards());
//             //    console.log( await contracts.claimZap.locker());
            
            
//             let claimZap = await claimZapFactory.deploy(
...
//             console.log("claim Zap: " + claimZap.address)
